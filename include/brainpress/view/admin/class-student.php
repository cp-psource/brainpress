...
class BrainPress_View_Admin_Student {
	private static $slug = 'brainpress_students';
	private static $title = '';
	private static $menu_title = '';
	private static $table_manager = null;

	public static function init() {
		self::$title = __( 'Kurse/Studenten', 'brainpress' );
		self::$menu_title = __( 'Studenten', 'brainpress' );
		...
		// Search Users
		add_action( 'wp_ajax_brainpress_user_search', array( __CLASS__, 'search_user' ) );
	...
	public static function pre_process() {
		...
		if ( empty( $view ) ) {
			self::$table_manager = new BrainPress_Helper_Table_Student;
	...
	public static function render_page() {
		...
		if ( empty( $view ) ) {
			...
			BrainPress_View_Admin_Student_Workbook::display();
		} elseif ( 'profile' == $view ) {
			BrainPress_View_Admin_Student_Profile::display();
		}
	}
