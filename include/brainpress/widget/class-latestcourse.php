...
class BrainPress_Widget_LatestCourse extends WP_Widget {

	public static function init() {
		add_action( 'widgets_init', array( 'BrainPress_Widget_LatestCourse', 'register' ) );
	}

	public static function register() {
		register_widget( 'BrainPress_Widget_LatestCourse' );
	}

	public function __construct() {
		$widget_ops = array(
			'classname' => 'cp_latest_courses_widget',
			'description' => __( 'Displays latest courses', 'brainpress' ),
		);

		parent::__construct( 'CP_Latest_Courses', __( 'Neueste Kurse', 'brainpress' ), $widget_ops );
	}
	...
	public function form( $instance ) {
		...
		<p><label for="<?php echo $this->get_field_id( 'limit' ); ?>"><?php _e( 'Anzahl der Kurse', 'brainpress' ); ?>:<br/>
		...
		<p><label for="<?php echo $this->get_field_id( 'button_title' ); ?>"><?php _e( 'Schaltflächentitel', 'brainpress' ); ?>:
			<input class="widefat" id="<?php echo $this->get_field_id( 'button_title' ); ?>" name="<?php echo $this->get_field_name( 'button_title' ); ?>" type="text" value="<?php echo( ! isset( $button_title ) ? __( 'See All Courses', 'brainpress' ) : esc_attr( $button_title ) ); ?>"/></label>
		</p>
	<?php
	}
	...
	public function widget( $args, $instance ) {
		...
		<div class="cp_featured_widget_course_link">
			<a href="<?php echo esc_url( home_url( '/' ) . BrainPress_Core::get_slug( 'course' ) ); ?>"><?php echo esc_html( $instance['button_title'] ); ?></a>
		</div>
