...
class BrainPress_Widget_Structure extends WP_Widget {

	public static function init() {
		add_action( 'widgets_init', array( 'BrainPress_Widget_Structure', 'register' ) );
	}

	public static function register() {
		register_widget( 'BrainPress_Widget_Structure' );
	}

	public function __construct() {
		$widget_ops = array(
			'classname' => 'cp_course_strucutre_widget',
			'description' => __( 'Zeigt eine ausgewählte Kursstruktur an', 'brainpress' ),
		);

		parent::__construct( 'CP_Course_Structure', __( 'Kursstruktur', 'brainpress' ), $widget_ops );
	}
