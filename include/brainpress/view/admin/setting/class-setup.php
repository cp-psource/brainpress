...
?>
		<br/>
<?php
		printf( __( '%s hat auch MarketPress mit dabei - Falls Du Kurse verkaufen möchtest, dann installiere es einfach über das BrainPress Dashboard.', 'brainpress' ), BrainPress::$name );
?>
		<br/>
