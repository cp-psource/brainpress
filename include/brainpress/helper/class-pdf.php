<?php
/**
 * @copyright psource ( http://psource.com/ )
 *
 ...
 * @return object
 */
class BrainPress_Helper_PDF extends CP_TCPDF {
	...
	public function Footer() {
		...
		$selected_font = BrainPress_Core::get_setting( 'reports/font', 'helvetica' );

		$the_font = apply_filters( 'brainpress_pdf_font', $selected_font );
	...
	public static function fonts() {
		...
		$fonts = array(
			'cid0cs.php' => __( 'Arial Unicode MS (Simplified Chinese)', 'brainpress' ),
			'cid0ct.php' => __( 'Arial Unicode MS (Chinese Traditional)', 'brainpress' ),
			'cid0jp.php' => __( 'Arial Unicode MS (Japanese)', 'brainpress' ),
			'cid0kr.php' => __( 'Arial Unicode MS (Korean)', 'brainpress' ),
			'courier.php' => __( 'Courier', 'brainpress' ),
			'courierb.php' => '',
			'courierbi.php' => '',
			'courieri.php' => '',
			'helvetica.php' => __( 'Helvetica', 'brainpress' ),
			'helveticab.php' => '',
			'helveticabi.php' => '',
			'helveticai.php' => '',
			'dejavusans.php' => __( 'DejaVu Sans', 'brainpress' ),
			'dejavusansb.php' => '',
			'dejavusansbi.php' => '',
			'dejavusansi.php' => '',
			'symbol.php' => __( 'Symbol', 'brainpress' ),
			'times.php' => __( 'Times-Roman', 'brainpress' ),
			'timesb.php' => '',
			'timesbi.php' => '',
			'timesi.php' => '',
			'uni2cid_ac15.php' => __( 'Adobe-CNS1-5', 'brainpress' ),
			'uni2cid_ag15.php' => __( 'Adobe-GB1-5', 'brainpress' ),
			'uni2cid_aj16.php' => __( 'Adobe-Japan1-6', 'brainpress' ),
			'uni2cid_ak12.php' => __( 'Adobe-Korea1-2', 'brainpress' ),
			'zapfdingbats.php' => __( 'ZapfDingbats', 'brainpress' ),
		);

		if ( defined( 'TCPDF_PLUGIN_ACTIVE' ) && TCPDF_PLUGIN_ACTIVE ) {
			$fonts = array_merge( $fonts, array(
				'aealarabiya.php' => __( 'Al Arabiya', 'brainpress' ),
				'aefurat.php' => __( 'Furat', 'brainpress' ),
				'dejavusanscondensed.php' => __( 'DejaVu Sans Condensed', 'brainpress' ),
				'dejavusanscondensedb.php' => '',
				'dejavusanscondensedbi.php' => '',
				'dejavusanscondensedi.php' => '',
				'dejavusansextralight.php' => __( 'DejaVu Sans ExtraLight', 'brainpress' ),
				'dejavusansmono.php' => __( 'DejaVu Sans Mono', 'brainpress' ),
				'dejavusansmonob.php' => '',
				'dejavusansmonobi.php' => '',
				'dejavusansmonoi.php' => '',
				'dejavuserif.php' => __( 'DejaVu Serif', 'brainpress' ),
				'dejavuserifb.php' => '',
				'dejavuserifbi.php' => '',
				'dejavuserifcondensed.php' => __( 'DejaVu Serif Condensed', 'brainpress' ),
				'dejavuserifcondensedb.php' => '',
				'dejavuserifcondensedbi.php' => '',
				'dejavuserifcondensedi.php' => '',
				'dejavuserifi.php' => '',
				'freemono.php' => __( 'Free Mono', 'brainpress' ),
				'freemonob.php' => '',
				'freemonobi.php' => '',
				'freemonoi.php' => '',
				'freesans.php' => __( 'Free Sans', 'brainpress' ),
				'freesansb.php' => '',
				'freesansbi.php' => '',
				'freesansi.php' => '',
				'freeserif.php' => __( 'Free Serif', 'brainpress' ),
				'freeserifb.php' => '',
				'freeserifbi.php' => '',
				'freeserifi.php' => '',
				'hysmyeongjostdmedium.php' => __( 'MyungJo Medium (Korean)', 'brainpress' ),
				'kozgopromedium.php' => __( 'Kozuka Gothic Pro (Japanese Sans-Serif)', 'brainpress' ),
				'kozminproregular.php' => __( 'Kozuka Mincho Pro (Japanese Serif)', 'brainpress' ),
				'msungstdlight.php' => __( 'MSung Light (Traditional Chinese)', 'brainpress' ),
				'pdfacourier.php' => __( 'PDFA Courier', 'brainpress' ),
				'pdfacourierb.php' => '',
				'pdfacourierbi.php' => '',
				'pdfacourieri.php' => '',
				'pdfahelvetica.php' => __( 'PDFA Helvetica', 'brainpress' ),
				'pdfahelveticab.php' => '',
				'pdfahelveticabi.php' => '',
				'pdfahelveticai.php' => '',
				'pdfasymbol.php' => __( 'PDFA Symbol', 'brainpress' ),
				'pdfatimes.php' => __( 'PDFA Times', 'brainpress' ),
				'pdfatimesb.php' => '',
				'pdfatimesbi.php' => '',
				'pdfatimesi.php' => '',
				'pdfazapfdingbats.php' => __( 'PDFA ZapfDingbats', 'brainpress' ),
				'robotolight.php' => __( 'Roboto Light', 'brainpress' ),
				'robotolightitalic.php' => __( 'Robot Light Italic', 'brainpress' ),
				'stsongstdlight.php' => __( 'STSong Light (Simplified Chinese)', 'brainpress' ),
			) );
		}

		// If you are hooking this, make sure you are using fonts for TCPDF and that they are located in relevant font path
		return apply_filters( 'brainpress_pdf_font_list', $fonts );
	...
	protected function getFontsList() {
		...
		$font_path = apply_filters( 'brainpress_pdf_font_path', CP_TCPDF_FONTS::_getfontpath() );
	...
	public static function make_pdf( $html, $args = array() ) {
		if ( ! isset( $args['title'] ) || empty( $args['title'] ) ) {
			$args['title'] = __( 'BrainPress Bericht', 'brainpress' );
		}
...
$pdf = new BrainPress_Helper_PDF( $page_orientation, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false );
		...
		$pdf->SetCreator( BrainPress::$name );
			...
			case 'F': case 'FI':
				...
				if ( isset( $args['url'] ) && ! empty( $args['url'] ) ) {
					if ( isset( $args['force_download'] ) && ! empty( $args['force_download'] ) ) {
						BrainPress_Helper_Utility::download_file_request( $furl );
					} else {
						return $furl;
					}
				} else {
	...
	public static function cache_path( $subdirectory = false ) {
		...
		$cache_path = apply_filters( 'brainpress_pdf_cache_path', trailingslashit( $uploads_dir['basedir'] ) . 'pdf-cache/' );
	...
	public static function cache_url() {
		$uploads_dir = wp_upload_dir();
		$cache_url = apply_filters( 'brainpress_pdf_cache_url', trailingslashit( $uploads_dir['baseurl'] ) . 'pdf-cache/' );
		return $cache_url;
	}
	...
	public static function pdf_notice() {
		...
		<div class="notice notice-error">
			<p><?php printf( esc_html__( 'BrainPress kann kein PDF generieren, da das Verzeichnis nicht beschreibbar ist: %s', 'brainpress' ), $cache_path); ?></p>
		</div>
		<?php
	}
