...
class BrainPress_Admin_GDPR {
    ...
    /**
     * Add brainpress Policy to "Privacy Policy" page during creation.
     *
     * @since 2.2.0
     */
    ...
    /**
     * Add privacy policy content for the privacy policy page using the new method.
     *
     * @since 2.3.7
     */
    public function add_privacy_policy_content() {
        if (function_exists('wp_add_privacy_policy_content')) {
            wp_add_privacy_policy_content(
                __('Plugin: BrainPress', 'brainpress'),
