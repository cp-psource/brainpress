 ...
 * @since 2.0.0
 */
class BrainPress_Data_Discussion_Cron {

	private static $option_name = 'new_comment_id';
	private static $hook = 'brainpress_send_comment_notification';
	...
	public static function add_cron_interval( $schedules ) {
		...
		$schedules[ self::$recurrance ] = array(
			'interval' => 900,
			'display'  => esc_html__( 'Jede Viertelstunde' ),
		);
		return $schedules;
	}
	...
	public static function send_notification() {
		...
		do {
			...
			BrainPress_Data_Discussion_Email::notify_all( $comment_id );
			$comment_id = self::_get_comment_id();
		} while ( $comment_id );
	}
