...
BrainPress_Admin_Forums::init_edit();
...
$title = BrainPress_Admin_Forums::get_label_by_name( 'add_new_item' );
if ( 0 < $the_id ) {
	$title = BrainPress_Admin_Forums::get_label_by_name( 'edit_item' );
}
...
?>
<div class="wrap brainpress_wrapper course-edit-forums">
<h2><?php
echo $title;
...
?>
		...
		<div id="poststuff">
			...
			<div id="post-body-content">
				<?php echo BrainPress_Helper_UI::get_admin_edit_title_field( $post->post_title, __( 'Gib den Titel des Themas ein', 'brainpress' ) ); ?>
				<br />
