...
/**
 * Helper class for working with BrainPress capabilities.
 *
 * Previously BrainPress_Capabilities
 *
 * @since 1.0.0
 */
class BrainPress_Data_Capabilities {
	...
	public static $capabilities = array(
		'instructor' => array(
			/* General */
			'brainpress_dashboard_cap' => 1,
			'brainpress_courses_cap' => 1,
			'brainpress_instructors_cap' => 0, // DEPRECATED
			'brainpress_students_cap' => 1,
			'brainpress_assessment_cap' => 1,
			'brainpress_reports_cap' => 1,
			'brainpress_notifications_cap' => 1,
			'brainpress_discussions_cap' => 1,
			'brainpress_settings_cap' => 1,
			/* Courses */
			'brainpress_create_course_cap' => 1,
			'brainpress_view_others_course_cap' => 1,
			'brainpress_update_course_cap' => 1,
			'brainpress_update_my_course_cap' => 1,
			'brainpress_update_all_courses_cap' => 0, // NOT IMPLEMENTED YET
			'brainpress_delete_course_cap' => 1,
			'brainpress_delete_my_course_cap' => 1,
			'brainpress_delete_all_courses_cap' => 0, // NOT IMPLEMENTED YET
			'brainpress_change_course_status_cap' => 0,
			'brainpress_change_my_course_status_cap' => 1,
			'brainpress_change_all_courses_status_cap' => 0, // NOT IMPLEMENTED YET
			/* Units */
			'brainpress_create_course_unit_cap' => 1,
			'brainpress_view_all_units_cap' => 0,
			'brainpress_update_course_unit_cap' => 1,
			'brainpress_update_my_course_unit_cap' => 1,
			'brainpress_update_all_courses_unit_cap' => 0, // NOT IMPLEMENTED YET
			'brainpress_delete_course_units_cap' => 1,
			'brainpress_delete_my_course_units_cap' => 1,
			'brainpress_delete_all_courses_units_cap' => 0, // NOT IMPLEMENTED YET
			'brainpress_change_course_unit_status_cap' => 1,
			'brainpress_change_my_course_unit_status_cap' => 1,
			'brainpress_change_all_courses_unit_status_cap' => 0, // NOT IMPLEMENTED YET
			/* Instructors */
			'brainpress_assign_and_assign_instructor_course_cap' => 0,
			'brainpress_assign_and_assign_instructor_my_course_cap' => 1,
			/* Facilitators */
			'brainpress_assign_my_course_facilitator_cap' => 1,
			'brainpress_assign_facilitator_cap' => 1,
			/* Classes */
			'brainpress_add_new_classes_cap' => 0,
			'brainpress_add_new_my_classes_cap' => 0,
			'brainpress_delete_classes_cap' => 0,
			'brainpress_delete_my_classes_cap' => 0,
			/* Students */
			'brainpress_invite_students_cap' => 0,
			'brainpress_invite_my_students_cap' => 1,
			'brainpress_withdraw_students_cap' => 0,
			'brainpress_withdraw_my_students_cap' => 1,
			'brainpress_add_move_students_cap' => 0,
			'brainpress_add_move_my_students_cap' => 1,
			'brainpress_add_move_my_assigned_students_cap' => 1,
			// 'brainpress_change_students_group_class_cap' => 0,
			// 'brainpress_change_my_students_group_class_cap' => 0,
			//'brainpress_add_new_students_cap' => 0, // DEPRECATED
			//'brainpress_send_bulk_my_students_email_cap' => 0, // DEPRECATED
			//'brainpress_send_bulk_students_email_cap' => 0, // DEPRECATED
			//'brainpress_delete_students_cap' => 0, // DEPRECATED
			/* Groups */
			'brainpress_settings_groups_page_cap' => 0,
			// 'brainpress_settings_shortcode_page_cap' => 0,
			/* Notifications */
			'brainpress_create_my_assigned_notification_cap' => 1,
			'brainpress_create_my_notification_cap' => 1,
			'brainpress_update_notification_cap' => 1,
			'brainpress_update_my_notification_cap' => 1,
			'brainpress_delete_notification_cap' => 1,
			'brainpress_delete_my_notification_cap' => 1,
			'brainpress_change_notification_status_cap' => 0,
			'brainpress_change_my_notification_status_cap' => 1,
			/* Discussions */
			'brainpress_create_my_assigned_discussion_cap' => 1,
			'brainpress_create_my_discussion_cap' => 1,
			'brainpress_update_discussion_cap' => 0,
			'brainpress_update_my_discussion_cap' => 1,
			'brainpress_delete_discussion_cap' => 0,
			'brainpress_delete_my_discussion_cap' => 1,
			'brainpress_change_discussion_status_cap' => 0,
			'brainpress_change_my_discussion_status_cap' => 1,
			/* Certificates */
			'brainpress_certificates_cap' => 0,
			'brainpress_create_certificates_cap' => 0,
			'brainpress_update_certificates_cap' => 0,
			'brainpress_delete_certificates_cap' => 0,
			/* Course Categories */
			'brainpress_course_categories_manage_terms_cap' => 1,
			'brainpress_course_categories_edit_terms_cap' => 1,
			'brainpress_course_categories_delete_terms_cap' => 0,
			/* Posts and Pages */
			'edit_pages' => 0,
	...
	public static function init_caps() {
		...
		if ( self::$is_admin ) {
			...
			//$current_user->allcaps['brainpress_delete_course_cap'] = true;
			...
			$current_caps = BrainPress_Data_Capabilities::get_instructor_capabilities();
	...
	/**
	 * Assign appropriate BrainPress capabilities for roles
	 *
	 * @since 1.2.3.3.
	 */
	public static function assign_role_capabilities( $user_id, $role, $old_role ) {
		...
		if ( 'administrator' == $role ) {
			...
			// Remove all BrainPress capabilities
			self::remove_instructor_capabilities( $user_id );

			$instructor_courses = BrainPress_Data_Instructor::get_assigned_courses_ids( $user_id );
			...
			$facilitated_courses = BrainPress_Data_Facilitator::get_facilitated_courses( $user_id, array( 'any' ), true, 0, 1 );
	...
	public static function fix_admin_capabilities() {
		...
		if ( user_can( $user_id, 'manage_options' )
			&& false === user_can( $user_id, 'brainpress_settings_cap' ) ) {
			self::assign_admin_capabilities( $user_id );
		}
	}
	...
	public static function assign_admin_capabilities( $user ) {
		if ( ! is_object( $user ) ) {
			$user_id = BrainPress_Helper_Utility::get_id( $user );
	...
	public static function can_manage_courses( $user_id = '' ) {
		...
		if ( user_can( $user_id, 'manage_options' ) ) {
			...
			$return = ! empty( $current_user->allcaps['brainpress_courses_cap'] );
		}
	...
	public static function can_view_others_course( $user_id = '' ) {
		...
		if ( ! $return ) {
			$return = user_can( $user_id, 'brainpress_view_others_course_cap' );
		}
	...
	public static function can_create_course( $user_id = '' ) {
		...
		if ( ! $return ) {
			if ( self::can_manage_courses( $user_id ) ) {
				$return = user_can( $user_id, 'brainpress_create_course_cap' );
			}
		}
	...
	public static function can_update_course( $course_id, $user_id = '' ) {
		...
		if ( false === $return ) {
			...
			$is_facilitator = BrainPress_Data_Facilitator::is_course_facilitator( $course_id, $user_id );
			...
			if ( $course_creator ) {
				if ( in_array( $post_status, array( 'private', 'draft' ) ) ) {
					...
					$return = user_can( $user_id, 'brainpress_update_my_course_cap' );
				}
			} elseif ( $is_instructor || $is_facilitator ) {
				$return = user_can( $user_id, 'brainpress_update_course_cap' );
			}
		}
	...
	public static function can_delete_course( $course_id, $user_id = '' ) {
		...
		if ( ! $return ) {
			if ( (int) $course_id > 0 ) {
				...
				if ( $course_creator ) {
					$return = user_can( $user_id, 'brainpress_delete_my_course_cap' );
				} elseif ( $is_instructor || $is_facilitator ) {
					$return = user_can( $user_id, 'brainpress_delete_course_cap' );
				}
			} else {
				$return = user_can( $user_id, 'brainpress_delete_course_cap' ) || user_can( $user_id, 'brainpress_delete_my_course_cap' );
			}
		}
	...
	public static function can_change_course_status( $course_id, $user_id = '' ) {
		...
		if ( ! $return ) {
			if ( (int) $course_id > 0 ) {
				...
				if ( $course_creator ) {
					$return = user_can( $user_id, 'brainpress_change_my_course_status_cap' );
				} elseif ( $is_instructor || $is_facilitator ) {
					$return = user_can( $user_id, 'brainpress_change_course_status_cap' );
				}
			} else {
				$return = user_can( $user_id, 'brainpress_change_my_course_status_cap' ) || user_can( $user_id, 'brainpress_change_course_status_cap' );
			}
		}
	...
	public static function can_manage_categories( $user_id = '' ) {
		...
		if ( ! $return ) {
			$return = user_can( $user_id, 'brainpress_course_categories_manage_terms_cap' );
		}
	...
	public static function can_create_unit( $user_id = '' ) {
		...
		$capability = apply_filters( 'brainpress_capabilities', 'brainpress_create_course_unit_cap' );
		...
		if ( ! $return ) {
			...
			if ( $course_creator ) {
				...
				if ( 'publish' != $post_status ) {
					...
					$return = user_can( $user_id, 'brainpress_update_my_course_unit_cap' );
				}
			} elseif ( $is_instructor || $is_facilitator ) {
				$return = self::can_create_unit() || user_can( $user_id, 'brainpress_update_course_unit_cap' );
			}
		}
	...
	public static function can_update_course_unit( $course, $unit_id = '', $user_id = '' ) {
		...
		if ( $my_unit ) {
			/** This filter is documented in include/brainpress/helper/class-setting.php */
			$capability = apply_filters( 'brainpress_capabilities', 'brainpress_update_my_course_unit_cap' );
			if ( user_can( $user_id, $capability ) ) {
				return true;
			}
		} else {
			/** This filter is documented in include/brainpress/helper/class-setting.php */
			$capability = apply_filters( 'brainpress_capabilities', 'brainpress_update_course_unit_cap' );
			if ( user_can( $user_id, $capability ) ) {
				return true;
			}
		}
	...
	public static function can_delete_course_unit( $course, $unit_id = '', $user_id = '' ) {
		...
		if ( $my_unit ) {
			/** This filter is documented in include/brainpress/helper/class-setting.php */
			$capability = apply_filters( 'brainpress_capabilities', 'brainpress_delete_my_course_units_cap' );
			if ( user_can( $user_id, $capability ) ) {
				return true;
			}
		} else {
			$capability = apply_filters( 'brainpress_capabilities', 'brainpress_delete_course_units_cap' );
			if ( user_can( $user_id, $capability ) ) {
				return true;
			}
		}
	...
	public static function can_change_course_unit_status( $course, $unit_id = '', $user_id = '' ) {
		...
		if ( $my_unit ) {
			/** This filter is documented in include/brainpress/helper/class-setting.php */
			$capability = apply_filters( 'brainpress_capabilities', 'brainpress_change_my_course_unit_status_cap' );
			if ( user_can( $user_id, $capability ) ) {
				return true;
			}
		} else {
			/** This filter is documented in include/brainpress/helper/class-setting.php */
			$capability = apply_filters( 'brainpress_capabilities', 'brainpress_change_course_unit_status_cap' );
			if ( user_can( $user_id, $capability ) ) {
				return true;
			}
		}
	...
	public static function can_assign_course_instructor( $course_id, $user_id = '' ) {
		...
		if ( ! $return ) {
			...
			if ( ! $course_id || $course_creator ) {
				$return = user_can( $user_id, 'brainpress_assign_and_assign_instructor_my_course_cap' );
			} else {
				$return = user_can( $user_id, 'brainpress_assign_and_assign_instructor_course_cap' );
			}
		}
	...
	public static function can_view_students( $user_id = '' ) {
		...
		if ( ! $return ) {
			$return = ( user_can( $user_id, 'brainpress_courses_cap' ) && user_can( $user_id, 'brainpress_students_cap' ) );
		}
	...
	public static function can_view_course_students( $course_id, $user_id = '' ) {
		...
		if ( ! $return ) {
			$return = user_can( $user_id, 'brainpress_students_cap' ) && 'publish' == $post_status;
	...
	public static function can_assign_course_student( $course_id, $user_id = '' ) {
		...
		$return = user_can( $user_id, 'manage_options' ) || user_can( $user_id, 'brainpress_add_move_students_cap' );
		...
		if ( ! $return ) {
			...
			if ( $course_creator ) {
				$return = user_can( $user_id, 'brainpress_add_move_my_students_cap' );
			} elseif ( $is_instructor || $is_facilitator ) {
				$return = user_can( $user_id, 'brainpress_add_move_my_assigned_students_cap' );
			}
		}
	...
	public static function can_invite_students( $course_id, $user_id = '' ) {
		...
		if ( ! $return ) {
			...
			if ( $course_creator ) {
				$return = user_can( $user_id, 'brainpress_invite_my_students_cap' );
			} elseif ( $is_instructor || $is_facilitator ) {
				$return = user_can( $user_id, 'brainpress_invite_students_cap' );
			}
		}
	...
	public static function can_withdraw_students( $course_id, $user_id = '' ) {
		...
		if ( ! $return ) {
			...
			if ( $course_creator ) {
				$return = user_can( $user_id, 'brainpress_withdraw_my_students_cap' );
			} elseif ( $is_instructor || $is_facilitator ) {
				$return = user_can( $user_id, 'brainpress_withdraw_students_cap' );
			}
		}
	...
	public static function can_create_student( $user_id = '' ) {
		...
		if ( ! $return ) {
			$return = user_can( $user_id, 'brainpress_add_new_students_cap' );
		}
	...
	public static function can_delete_student( $user_id = '' ) {
		...
		if ( ! $return ) {
			$return = user_can( $user_id, 'brainpress_delete_students_cap' );
		}
	...
	public static function can_add_course_student( $course, $user_id = '' ) {
		 ...
		 */
		/** This filter is documented in include/brainpress/helper/class-setting.php */
		$capability = apply_filters( 'brainpress_capabilities', 'brainpress_add_move_students_cap' );
		if ( user_can( $user_id, $capability ) ) {
			return true;
		}
		/**
		...
		if ( self::is_course_creator( $course, $user_id ) ) {
			$capability = apply_filters( 'brainpress_capabilities', 'brainpress_add_move_my_students_cap' );
			if ( user_can( $user_id, $capability ) ) {
				return true;
			}
		}
		...
		// Facilitator
		$is_facilitator = BrainPress_Data_Facilitator::is_course_facilitator( $course_id, $user_id );
		if ( BrainPress_Data_Instructor::is_assigned_to_course( $user_id, $course_id ) || $is_facilitator ) {
			/** This filter is documented in include/brainpress/helper/class-setting.php */
			$capability = apply_filters( 'brainpress_capabilities', 'brainpress_add_move_my_assigned_students_cap' );
			if ( user_can( $user_id, $capability ) ) {
				return true;
			}
		}
	...
	public static function can_withdraw_course_student( $course, $user_id = '' ) {
		 ...
		 */
		/** This filter is documented in include/brainpress/helper/class-setting.php */
		$capability = apply_filters( 'brainpress_capabilities', 'brainpress_withdraw_students_cap' );
		if ( user_can( $user_id, $capability ) ) {
			return true;
		}
		/**
		...
		$course_id = is_object( $course )? $course->ID : $course;
		if ( self::is_course_creator( $course, $user_id ) ) {
			$capability = apply_filters( 'brainpress_capabilities', 'brainpress_withdraw_my_students_cap' );
			if ( user_can( $user_id, $capability ) ) {
				return true;
			}
		}
	...
	public static function can_add_notifications( $user_id = null ) {
		...
		$courses = BrainPress_Data_Instructor::get_assigned_courses_ids( $user_id );
		if ( empty( $courses ) ) {
			return false;
		}
	...
	public static function can_add_notification( $course, $user_id = '' ) {
		 ...
		 */
		/** This filter is documented in include/brainpress/helper/class-setting.php */
		$capability_my = apply_filters( 'brainpress_capabilities', 'brainpress_create_my_notification_cap' );
		$capability_assigned = apply_filters( 'brainpress_capabilities', 'brainpress_create_my_assigned_notification_cap' );
		$is_facilitator = BrainPress_Data_Facilitator::is_course_facilitator( $course_id, $user_id );
		if ( ! is_object( $course ) ) {
	...
	public static function can_update_notification( $notification, $user_id = '' ) {
		 ...
		 */
		/** This filter is documented in include/brainpress/helper/class-setting.php */
		$capability = apply_filters( 'brainpress_capabilities', 'brainpress_update_notification_cap' );
		if ( user_can( $user_id, $capability ) ) {
			return true;
		}
		/**
		...
		if ( self::is_notification_creator( $notification, $user_id ) ) {
			/** This filter is documented in include/brainpress/helper/class-setting.php */
			$capability = apply_filters( 'brainpress_capabilities', 'brainpress_update_my_notification_cap' );
			if ( user_can( $user_id, $capability ) ) {
				return true;
			}
		}
	...
	public static function can_delete_notification( $notification, $user_id = '' ) {
		 ...
		 */
		/** This filter is documented in include/brainpress/helper/class-setting.php */
		$capability = apply_filters( 'brainpress_capabilities', 'brainpress_delete_notification_cap' );
		if ( user_can( $user_id, $capability ) ) {
			return true;
		}
		/**
		...
		if ( self::is_notification_creator( $notification, $user_id ) ) {
			/** This filter is documented in include/brainpress/helper/class-setting.php */
			$capability = apply_filters( 'brainpress_capabilities', 'brainpress_delete_my_notification_cap' );
			if ( user_can( $user_id, $capability ) ) {
				return true;
			}
		}
	...
	public static function can_change_status_notification( $notification, $user_id = '' ) {
		 ...
		 */
		/** This filter is documented in include/brainpress/helper/class-setting.php */
		$capability = apply_filters( 'brainpress_capabilities', 'brainpress_change_notification_status_cap' );
		if ( user_can( $user_id, $capability ) ) {
			return true;
		}
		/**
		...
		if ( self::is_notification_creator( $notification, $user_id ) ) {
			/** This filter is documented in include/brainpress/helper/class-setting.php */
			$capability = apply_filters( 'brainpress_capabilities', 'brainpress_change_my_notification_status_cap' );
			if ( user_can( $user_id, $capability ) ) {
				return true;
			}
		}
	...
	public static function can_add_discussion( $course, $user_id = '' ) {
		...
		if ( ! $course ) {
			return ( user_can( $user_id, 'courespress_create_discussion_cap' ) ||
					user_can( $user_id, 'brainpress_create_my_discussion_cap' ) ||
					user_can( $user_id, 'brainpress_create_my_assigned_discussion_cap' ) );
		}
		 ...
		 */
		if ( self::is_course_instructor( $course, $user_id ) || BrainPress_Data_Facilitator::is_course_facilitator( $course_id, $user_id ) ) {
			/** This filter is documented in include/brainpress/helper/class-setting.php */
			$capability = apply_filters( 'brainpress_capabilities', 'brainpress_create_my_assigned_discussion_cap' );
			if ( user_can( $user_id, $capability ) ) {
				return true;
			}
		}
	...
	public static function can_update_discussion( $discussion, $user_id = '' ) {
		...
		/** This filter is documented in include/brainpress/helper/class-setting.php */
		$capability = apply_filters( 'brainpress_capabilities', 'brainpress_update_discussion_cap' );
		$capability2 = apply_filters( 'brainpress_capabilities', 'brainpress_update_my_discussion_cap' );
	...
	public static function can_delete_discussion( $discussion, $user_id = '' ) {
		...
		/** This filter is documented in include/brainpress/helper/class-setting.php */
		$capability = apply_filters( 'brainpress_capabilities', 'brainpress_delete_discussion_cap' );
		$capability2 = apply_filters( 'brainpress_capabilities', 'brainpress_delete_my_discussion_cap' );
	...
	public static function can_change_status_discussion( $discussion, $user_id = '' ) {
		...
		/** This filter is documented in include/brainpress/helper/class-setting.php */
		$capability = apply_filters( 'brainpress_capabilities', 'brainpress_change_discussion_status_cap' );
		$capability2 = apply_filters( 'brainpress_capabilities', 'brainpress_change_my_discussion_status_cap' );
	...
	public static function is_notification_creator( $notification, $user_id = '' ) {
		return self::is_creator(
			$notification,
			BrainPress_Data_Notification::get_post_type_name(),
			$user_id
		);
	}
	...
	public static function reset_user_capabilities( $user ) {
		...
		$custom_reset = apply_filters(
			'brainpress_reset_user_capabilities',
			false,
			$user
		);
		...
		do_action( 'brainpress_did_reset_user_capabilities', $user );
	}
	...
	/**
	 * Removes all special BrainPress capabilites for an instructor
	 *
	 * @since  2.0.0
	...
	public static function get_instructor_capabilities() {
		$default_capabilities = array_keys( BrainPress_Data_Capabilities::$capabilities['instructor'], 1 );
	...
	public static function filter_row_actions( $actions, $tag ) {
		if ( ! empty( $tag->taxonomy ) && BrainPress_Data_Course::get_post_category_name() == $tag->taxonomy ) {
			$instructor_capabilities = BrainPress_Data_Capabilities::get_instructor_capabilities();

			if ( ! $instructor_capabilities['brainpress_course_categories_edit_terms_cap'] ) {
				// Remove edit link
	...
	public static function get_user_capabilities() {
		...
		$caps = apply_filters( 'brainpress_current_user_capabilities', $caps );
	...
	public static function can_assign_facilitator( $course_id, $user_id = 0 ) {
		...
		if ( ! $return ) {
			...
			if ( $is_author ) {
				$return = user_can( $user_id, 'brainpress_assign_my_course_facilitator_cap' );
			}

			// If no cap, check if user can assign facilitator to any course
			if ( ! $return ) {
				$return = user_can( $user_id, 'brainpress_assign_facilitator_cap' );
			}
		}
	...
	public static function can_edit_comment( $comment_id, $user_id = null ) {
		...
		$course_id = BrainPress_Data_Module::get_course_id_by_module( $module_id );

		if ( BrainPress_Data_Facilitator::is_course_facilitator( $course_id, $user_id ) ) {
			return true;
		}

		if ( BrainPress_Data_Instructor::is_assigned_to_course( $user_id, $course_id ) ) {
			return true;
		}
		return false;
	}
	...
	public static function course_capabilities() {
		...
		$module_type = BrainPress_Data_Module::get_post_type_name();
		$unit_type = BrainPress_Data_Unit::get_post_type_name();
		$noti = BrainPress_Data_Notification::get_post_type_name();

		$brainpress_post_types = compact( 'course_type', 'unit_type', 'module_type', 'noti' );//compact( $course_type, $unit_type, $module_type, $noti );

		foreach ( $brainpress_post_types as $post_type ) {
