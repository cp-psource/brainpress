...
class CP_TCPDF_FONTS {
	 ...
	 * @public static
	 */
	public static function UTF8ToUTF16BE($str, &$currentfont, $isunicode=true, $setbom=false) {
		if (!$isunicode) {
	...
	public static function utf8StrRev($str, &$currentfont, $setbom=false, $forcertl=false, $isunicode=true) {
		return self::utf8StrArrRev(self::UTF8StringToArray($str, $isunicode, $currentfont), $str, $currentfont, $setbom, $forcertl, $isunicode);
	}
