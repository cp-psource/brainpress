		...
		$defaults = apply_filters(
			...
			array(
				...
				BrainPress_Helper_Email::REGISTRATION => array(
					...
					'description' => __( 'Einstellungen für einen E-Mail-Studenten erhältst Du bei der Registrierung des Kontos.', 'brainpress' ),
				...
				BrainPress_Helper_Email::ENROLLMENT_CONFIRM => array(
					...
					'description' => __( 'Einstellungen für einen E-Mail-Studenten erhältst Du bei der Einschreibung.', 'brainpress' ),
				...
				BrainPress_Helper_Email::INSTRUCTOR_ENROLLMENT_NOTIFICATION => array(
					...
					'description' => __( 'Die Einstellungen für einen E-Mail-Kursleiter werden angezeigt, wenn sich ein neuer Student einschreibt.', 'brainpress' ),
				...
				BrainPress_Helper_Email::COURSE_INVITATION => array(
					...
					'description' => __( 'Einstellungen für einen E-Mail-Studenten erhältst Du, wenn Du eine Einladung zu einem Kurs erhältst.', 'brainpress' ),
				...
				BrainPress_Helper_Email::COURSE_INVITATION_PASSWORD => array(
					...
					'description' => __( 'Einstellungen für einen E-Mail-Studenten erhältst Du, wenn Du eine Einladung (mit Passcode) zu einem Kurs erhältst.', 'brainpress' ),
					'content_help_text' => __( 'Diese Codes werden durch tatsächliche Daten ersetzt: ', 'brainpress' ) . implode( ', ', $course_invitation_fields ),
					'order' => 4,
				),
				BrainPress_Helper_Email::INSTRUCTOR_INVITATION => array(
				...
				BrainPress_Helper_Email::NEW_ORDER => array(
					...
					'description' => __( 'Einstellungen für einen E-Mail-Studenten erhältst Du bei der Bestellung.', 'brainpress' ),
				...
				BrainPress_Helper_Email::COURSE_START_NOTIFICATION => array(
					...
					'description' => __( 'Einstellungen für eine E-Mail, die zu Beginn eines Kurses an die Studenten gesendet werden soll.', 'brainpress' ),
				...
				BrainPress_Helper_Email::DISCUSSION_NOTIFICATION => array(
					...
					'description' => __( 'Einstellungen für eine E-Mail, die an Studenten und Kursleiter gesendet werden soll.', 'brainpress' ),
				...
				BrainPress_Helper_Email::UNIT_STARTED_NOTIFICATION => array(
					...
					'description' => __( 'Einstellungen für eine E-Mail, die an Studenten gesendet werden soll, wenn eine Einheit gestartet wurde.', 'brainpress' ),
